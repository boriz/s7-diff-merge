    ...
    public static class AWLSourceParser
    {
        ...
        private static S7Block CreateBlock(string blockType, string blockNumber, string type)
        {
            ...
            switch (blockType.ToUpper())
            {
                ...
                case ("FUNCTION"):
                    {
                        akBlock = new S7FunctionBlock() { BlockType = DataTypes.PLCBlockType.FC, BlockLanguage = PLCLanguage.STL };
                ...
                case ("FUNCTION_BLOCK"):
                    {
                        akBlock = new S7FunctionBlock() { BlockType = DataTypes.PLCBlockType.FB, BlockLanguage = PLCLanguage.STL };
