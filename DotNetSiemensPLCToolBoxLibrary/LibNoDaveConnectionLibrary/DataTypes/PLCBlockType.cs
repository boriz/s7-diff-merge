namespace DotNetSiemensPLCToolBoxLibrary.DataTypes
{
    ...
    {
        AllBlocks = 0xFFFF, //Change to 0xffff
        AllEditableBlocks = 0xFFFE, //Change to 0xfffe

        SourceBlock = 0xFFFD, //This is a Source Block. Don't know block type it'll compiles to
