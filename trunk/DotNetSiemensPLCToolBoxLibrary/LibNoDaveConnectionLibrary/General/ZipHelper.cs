...
{    
    public class ZipHelper
    {
        ...
        public void ArchiveFolder(string strFolderPath, string strFilePath)
        {
            FastZip fz = new FastZip();
            fz.CreateEmptyDirectories = true;           
            fz.CreateZip(strFilePath, strFolderPath, true, "");
        }


        public void UnpackToFolder(string strFilePath, string strFolderPath)
        {
            FastZip fz = new FastZip();
            fz.ExtractZip(strFilePath, strFolderPath, FastZip.Overwrite.Always, null, null, null, true);
        }
        ...
        public DateTime FileModDateTime(string file)
        {
            if (_zipFile == null)
            {
